...
const TeamMember = () => {
    return (
        <section className="py-16 bg-gradient-to-r from-purple-50 via-blue-50 to-pink-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 ">
                    {team.map((member, index) => (
                        <motion.div
                            ...
                            className="bg-white rounded-xl backdrop-blur-lg rounded shadow-lg hover:shadow-2xl transition p-6 flex flex-col items-center text-center"
                        >
                            {/* Image */}
                            <img
                                src={member.image}
                            ...
                            <div className="flex space-x-4 text-lg mt-4 text-indigo-600">
