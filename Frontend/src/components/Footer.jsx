...
const Footer = () => {
  return (
    <footer className="bg-white/70 text-black pt-16 pb-10 relative rounded-lg overflow-hidden rounded-2xl  hover:shadow-[0_8px_40px_rgba(255,105,0,0.25)]">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link
                ...
                className="flex items-center gap-2 hover:text-blue-400 transition"
              >
                <FaArrowRight size={12} /> Cultural Events
              </Link>
            </li>
            <li>
              <Link
                ...
                className="flex items-center gap-2 hover:text-blue-400 transition"
              >
                <FaArrowRight size={12} /> Corporative Events
              </Link>
            </li>
            <li>
              <Link
      ...
      {/* Bottom Bar */}
      <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-pink-50 mt-10 py-4">
