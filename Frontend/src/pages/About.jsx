...
import imagePng from '/images/aboutUs_bg_2.png';
...
const About = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-pink-50 rounded-lg">
            <Navbar />
            <section className="w-full bg-cover  bg-center bg-no-repeat bg-[url('/images/aboutUs_bg_2.png')] py-20 md:px-32 h-[500px]">
            ...
            <section className="bg-gradient-to-r from-purple-50 via-blue-50 to-pink-50 py-16 px-6">
            ...
            {/* Events Section */}
            <section className="bg-gradient-to-r from-purple-50 via-blue-50 to-pink-50 overflow-hidden w-full">
