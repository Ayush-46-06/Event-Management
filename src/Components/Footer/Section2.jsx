    ...
    <div className='mt-8 grid xl:grid-cols-2'>
      ...
      <div className='left grid sm:grid-cols-3 gap-10 mb-10'>
        <div>
            ...
            <p className='text-gray-400 mb-2'>near Renu Sharma Foundation, Pataudi, Gurgaon, Haryana 122503</p>
            <p className='text-gray-400 mb-2'>Gurgaon</p>
      ...
      <div className='right xl:px-25 mb-10'>
        ...
        <p className='text-gray-400 mb-2'>Get exclusive deals by signing up to our Portal.</p>
        <div className='flex flex-col gap-2'>
            ...
            <button className='bg-blue-600 text-white p-2 rounded-md xl:w-full sm:w-1/2 w-[75%] cursor-pointer hover:scale-105 transition duration-300 ease-in-out'>Sign Up</button>
        </div>
      </div>
