...
const AboutUs = () => {
    return (
        <div className="bg-gradient-to-r from-purple-100 via-blue-100 to-pink-100 min-h-screen rounded-lg flex flex-col justify-center items-center  transition-all duration-700">
            {/* Section Heading */}
            <motion.h1
            ...
            >
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae optio quos labore non sapiente officiis nihil perferendis. Fuga deserunt tempora hic architecto quo dolor quia voluptas, voluptates voluptatum corrupti animi!
            </motion.p>

            {/* Image + Text Side by Side */}
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 max-w-6xl w-full pb-16">
                {/* Image Section */}
                <motion.div
                ...
                >
                    ...
                    <p className="text-md text-indigo-800 leading-relaxed">
                        ...
                        quidem, quod, quia, voluptatum quos quae voluptatem quibusdam
                        voluptates quas officiis. Quaerat, quidem. Quisquam, quod, quia,
                        voluptatum quos quae voluptatem quibusdam voluptates quas officiis.
                    </p>
